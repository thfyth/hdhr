  ...
  <div class="main staff-mian">
    <div class="title-box" style="width: auto">
      ...
      <div class="titles-list">
        <el-button class="add" @click="addEmp">添加</el-button>
        <el-button type="submit" @click="uploadModel"
          >导出员工信息模板</el-button
        >
        ...
        <el-button class="insert">搜索</el-button>
        <el-button class="insert" type="primary" @click="drawerFun"
          >筛选</el-button
        >
      </div>
    </div>
     <div class="staff-info">
          <span v-for="(item,index) in emTotalList" :key="index" :class="{'active':index == isActive}" @click="getStatus(item.status,index)">
        ...
        <div class="tree-view">
          ...
          >
            <div class="custom-tree-node" slot-scope="{ data }">
              <div @click="getOrgId(data)" :class="{'active':data.orgId == orgActive}">{{ data.orgName }}</div>
            </div>
          </el-tree>
        </div>
      </div>
              ...
              >
                <div>
                  ...
                  >
                    <div class="contract-box">
                      ...
                      <div>
                        <div class="contract-list">
                          <el-checkbox v-model="contract.labor"
                            >劳动合同</el-checkbox
                          >
                        </div>
                    ...
                    <el-button icon="el-icon-edit" slot="reference"
                      >选择合同</el-button
                    >
                  </el-popover>
                </div>
...
export default {
  ...
  methods: {
    ...
    addEmp() {
      ...
      this.$router.push({
        path: "/personnel/staffInfo/addEmployees/"+this.orgId+"&"+this.parentIdAll,
      });
    ...
    uploadModel() {
      ...
      ajax({
        method: "post",
        url: "http://192.168.1.105:9004/api/employee/exportTemplate",
    ...
    exportTemp(e){
      ...
      ajax({
        method: "post",
        url: "http://192.168.1.105:9004/api/employee/exportTemplates",
        responseType: "arraybuffer",
        data
      })
      // console.log(123);
